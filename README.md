...
│   ├── src/
│   │   ├── app/
│   │   │   ├── apartment/           # Apartment management module
...
│   └── package.json
│
└── aspnet-core/                      # .NET backend solution
    └── src/
        ├── ITE.Bookify.Domain/              # Domain layer (entities, domain logic)
        │   ├── Apartments/                  # Apartment domain entities
        │   ├── Bookings/                    # Booking domain entities
        │   └── Reviews/                     # Review domain entities
        │
        ├── ITE.Bookify.Domain.Shared/       # Shared domain objects (DTOs, constants)
        │
        ├── ITE.Bookify.Application/         # Application layer (services, handlers)
        │   ├── Apartments/                  # Apartment application services
        │   ├── Bookings/                    # Booking application services
        │   └── Reviews/                     # Review application services
        │
        ├── ITE.Bookify.Application.Contracts/ # Application contracts (interfaces, DTOs)
        │
        ├── ITE.Bookify.EntityFrameworkCore/   # EF Core data access layer
        │
        ├── ITE.Bookify.HttpApi/             # HTTP API layer
        │
        ├── ITE.Bookify.HttpApi.Host/        # API host application
        │   └── appsettings.json             # Application configuration
        │
        └── ITE.Bookify.DbMigrator/          # Database migration tool
```
